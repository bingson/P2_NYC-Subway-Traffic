...
def mann_whitney_plus_means(turnstile_weather):
    ...
    ### YOUR CODE HERE ###
    '''for the ENTRIESn_hourly column in the turnstile_weather dataframe.'''
...
#    print rain_ENTRIESn_hourly.value_counts()
#    print no_rain_ENTRIESn_hourly.value_counts()
#    print turnstile_master.value_counts()
...
#    p = #p-value comparing the number of entries with rain and the number of entries without rain
